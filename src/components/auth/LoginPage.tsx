...
export const LoginPage: React.FC<LoginPageProps> = ({
  ...
  const { loginWithEmail, loginWithGoogle, resetPassword, authError } = useAuth();
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Sign in to Insight<span className="text-blue-600">AI</span></h1>
          <p className="text-xs text-slate-500 font-medium">Enterprise AI Data Analytics Platform</p>
        </div>
        ...
        <Card className="shadow-soft-xl p-7 space-y-5 border-slate-200/80">
          ...
          {resetSent && (
            <div className="p-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-semibold space-y-1">
              ...
              <p className="text-[11px] text-emerald-700 font-normal pl-6">
                • Please check your <strong>Spam / Junk</strong> folder (from <em>noreply@insight-ai-877a6.firebaseapp.com</em>).<br />
                • If you originally signed up with Google, click <strong>"Continue with Google"</strong> above.
              </p>
            </div>
          )}
